...
SRC_URI:append:evb-ast2600 = " \
  file://state_config_evb-ast2600.ini \
  file://mctp-binding_evb-ast2600.sh \
"
...
do_install:append() {
    ...
    install -m 0755 ${UNPACKDIR}/mctp-binding_${MACHINE}.sh ${D}${sbindir}/mctp-binding.sh
    ...
    install -m 0644 ${UNPACKDIR}/state_config_${MACHINE}.ini \
